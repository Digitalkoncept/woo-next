...
const Price = ({ regularPrice = 0, salesPrice }) => {
    ...
    return (
        <h6 className="product-price text-gray-800 font-bold  mb-5">
            {/* Regular price */}
            ...
            {/* Discount percent */}
            <span className="product-discount text-green-600  text-sm font-normal">{productMeta?.discountPercent}</span>
        </h6>
    )
}
