...
const Carousel = (props) => {
  ...
  return (
    <div className="carousel my-12 lg:mx-6 lg:px-10 py-10 mx-auto container bg-white">
      ...
      <div className="relative overflow-hidden">
        ...
        >
          { productCategories.length ? (
				productCategories.map( ( productCategory, index ) => <Card key={ productCategory?.id ?? index }  category={ productCategory }/> )
			) : null }
